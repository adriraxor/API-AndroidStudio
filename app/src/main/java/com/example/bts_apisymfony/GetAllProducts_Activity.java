...
public class GetAllProducts_Activity extends ListActivity {
    ...
    protected void onStart() {
        ...
        RequestQueue queue = Volley.newRequestQueue(GetAllProducts_Activity.this);

        //url du service à consommer
        String url = "http://192.168.187.138:8082/bts-app/public/ApiAllProducts";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        SimpleAdapter adapter = new SimpleAdapter(GetAllProducts_Activity.this, listAllProducts, R.layout.custom_row_view_products, new String[] {"nom", "libelle", "tarifProduit", "stock", "nomCategorie", "image"}, new int[] {R.id.text1, R.id.text2, R.id.text3, R.id.text4, R.id.text5, R.id.text6});
